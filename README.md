...
3. Create a new project in react, and implements a new screen with a form to create a new person, then add the person to the queue
4. Print the queue in screen according to the arrival date
